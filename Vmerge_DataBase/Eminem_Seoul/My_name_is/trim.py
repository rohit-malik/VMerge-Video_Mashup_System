...
while val < 599:
    ...
    file_name = 'event_my_name_is3_'+str(i)+'_'+str(j)+'.mp4'
    x = "ffmpeg -i ~/VMerge/VMERGE_OVERLAP/VMERGE/overlap/Eminem_Seoul/My_name_is/E3.mp4 -ss {0}  -to {1} -c:v copy -c:a copy {2}".format(start_cut,end_cut,file_name)
    p = subprocess.call(x,shell=True)
    print("================================================================\n")
    print("================================================================\n")
    print("================================================================\n")
